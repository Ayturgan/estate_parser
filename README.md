...
- **Управление парсингом** - запуск/остановка по источникам, мониторинг задач
...
- **Логи и мониторинг** - real-time просмотр системных логов
...
**🕷️ Парсинг** (`/scraping`)
- Управление парсерами по источникам
...
**📜 Логи** (`/logs`)
- Real-time системные логи
- Логи парсинга и обработки
- Фильтрация по типам
...
│   │   ├── scraping.html        # Управление парсингом
│   │   ├── ads.html             # Объявления
│   │   ├── duplicates.html      # Дубликаты
│   │   ├── logs.html            # Логи
