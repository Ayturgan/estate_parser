    ...
    card.innerHTML = `
        <div class="card h-100 shadow-sm">
            <div class="position-relative">
                ...
                ${ad.is_realtor ? '<span class="badge bg-info position-absolute top-0 end-0 m-2">Риэлтор</span>' : ''}
...
function populateAdModal(data) {
    ...
    if (ad.is_realtor !== undefined) charFields.push(`<strong>Риэлтор:</strong> ${ad.is_realtor ? 'Да' : 'Нет'}`);
    if (ad.is_vip) charFields.push(`<strong>VIP:</strong> Да`);
